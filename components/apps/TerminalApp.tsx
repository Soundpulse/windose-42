  ...
  const handleCommand = (e: React.FormEvent) => {
    ...
    if (restrictedCmds.includes(baseCmd)) {
      ...
      response = [
        ...
        "SYSTEMS ENGINEER: FastAPI, Node.js, Postgres, MongoDB, Redis, OR-Tools",
        "DATA STRATEGIST: PowerBI, Python, Pandas, SQL, Spark",
        "CREATIVE OPERATOR: Adobe PS, Adobe AI, Capcut",
        "GENERATIVE AI: Stable Diffusion, SDXL, Midjourney, AI Video Gen",
        "LLM APPLICATIONS: Gemini, PydanticAI, FastMCP, LangChain, Livekit, LoRA",
