        ...
        <div className="space-y-8">
          <div className="group relative border border-gray-800 p-6 hover:border-white transition-colors bg-black/50 backdrop-blur-sm">
            ...
            <div className="flex justify-between items-start mb-4">
              <span className="text-[10px] text-gray-300">◆ 0x0E</span>
              <span className="text-[10px] px-2 py-0.5 border border-gray-600 text-white">CERTIFICATION</span>
            </div>
            <h3 className="text-lg font-light mb-2">Claude Partner Network</h3>
            <p className="text-xs text-white leading-relaxed uppercase tracking-tight">
              Joined the Claude Partner Network.
            </p>
            <div className="mt-4 text-[9px] text-gray-600">TIMESTAMP: 2026.04.19</div>
          </div>
          ...
          <div className="group relative border border-gray-800 p-6 hover:border-white transition-colors bg-black/50 backdrop-blur-sm">
            ...
            <div className="flex justify-between items-start mb-4">
              <span className="text-[10px] text-gray-300">◆ 0x0D</span>
              <span className="text-[10px] px-2 py-0.5 border border-gray-600 text-white">STARTUP GRANT</span>
            </div>
            <h3 className="text-lg font-light mb-2">Sentry for Startups Grant</h3>
            <p className="text-xs text-white leading-relaxed uppercase tracking-tight">
              Accepted into the Sentry for Startups program.
            </p>
            <div className="mt-4 text-[9px] text-gray-600">TIMESTAMP: 2026.01.30</div>
          </div>
