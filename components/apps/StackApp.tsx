      ...
      <div className="max-w-4xl mx-auto py-8">
        ...
        <div className="mb-16 relative">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-light tracking-tighter uppercase italic">Full_Spectrum_Core</h1>
              <div className="text-[10px] text-gray-500 tracking-[0.4em] mt-1 uppercase">0 TO 1 PRODUCT ARCHITECT // JACK OF ALL TRADES</div>
            </div>
          </div>
          <p className="text-gray-200 text-xs leading-relaxed max-w-xl border-l border-gray-800 pl-4 py-2 italic uppercase tracking-tighter">
            "I excel at built-from-zero initiatives. A Generalist by design, I bridge the gap between abstract business strategy and low-level technical execution."
          </p>
        </div>
          ...
          {roles.map((item, idx) => (
            ...
            >
              <div className="flex justify-between items-start mb-6">
                ...
                <span className="text-[8px] opacity-30 group-hover:opacity-100 font-bold uppercase tracking-widest">SR_UNIT_0{idx + 1}</span>
              </div>
              
              <div className="flex-1">
                <h3 className="text-sm font-bold uppercase tracking-tighter mb-2">{item.role}</h3>
                <p className="text-[10px] leading-relaxed group-hover:opacity-100 mb-6 uppercase text-white">
                  {item.desc}
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-1 mt-auto pt-4 border-t border-gray-900 group-hover:border-black/10">
                {item.techs.map((t, i) => (
                  <span key={i} className="text-[8px] px-1.5 py-0.5 border border-gray-700 group-hover:border-black/20 uppercase text-gray-200">
                    {t}
                  </span>
                ))}
              </div>
