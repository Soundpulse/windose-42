import { User, Code, Terminal, Activity, MessageCircle, Map, Folder, Trophy, Layers } from 'lucide-react';
...
export const INITIAL_WINDOWS: WindowState[] = [
  ...
  { id: 'achievements', title: 'Achievements', isOpen: false, isMinimized: false, zIndex: 101, icon: <Trophy size={14} /> },
...
export const LOCATIONS: Location[] = [
  ...
  { id: 'uk', name: 'Newcastle', label: 'Bachelors @ Newcastle', description: 'BSc Computer Science | 2017-2020', line: 'main' },
  { id: 'ny', name: 'New York (Cornell)', label: 'Masters @ Cornell', description: 'Cornell Tech NYC | MEng Computer Science | 2024-2025', line: 'main' },
  ...
  { id: 'yunnan', name: 'Yunnan', label: 'Travel', description: 'Ethnic diversity and natural beauty.', line: 'asia_north' },
  ...
  { id: 'philly', name: 'Philadelphia', label: 'Travel', description: 'The City of Brotherly Love.', line: 'east_coast' },
...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'Modern full-stack architecture featuring Next.js, FastAPI, PostgreSQL and Redis for low-latency SaaS.',
